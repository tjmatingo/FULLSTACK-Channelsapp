    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.FileField(blank=True, null=True, upload_to=server.models.categoryIconUploadPath)),
            ],
        ),
        migrations.CreateModel(
            name='Server',
            fields=[
                ...
                ('banner', models.ImageField(blank=True, null=True, upload_to=server.models.serverBannerUploadPath, validators=[server.validators.validate_image_file_extension])),
                ('icon', models.ImageField(blank=True, null=True, upload_to=server.models.serverIconUploadPath, validators=[server.validators.validate_icon_image_size, server.validators.validate_image_file_extension])),
